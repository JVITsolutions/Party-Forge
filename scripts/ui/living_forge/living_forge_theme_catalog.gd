...
const _STYLEBOX_SLOTS: Array[Array] = [
	...
	[&"LivingForgePrimaryButton", &"hover_pressed"],
	[&"LivingForgePrimaryButton", &"focus"],
	[&"LivingForgeStartButton", &"normal"],
	[&"LivingForgeStartButton", &"hover"],
	[&"LivingForgeStartButton", &"pressed"],
	[&"LivingForgeStartButton", &"hover_pressed"],
	[&"LivingForgeStartButton", &"focus"],
