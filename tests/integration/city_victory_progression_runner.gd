...
func _run() -> void:
	...
	_assert(after_first != null and after_first.passive_points_available == 1 and after_first.passive_points_lifetime_earned == 1, "first unique victory grants exactly one passive point")
	...
	_assert(after_second != null and after_second.passive_points_available == 2 and after_second.passive_points_lifetime_earned == 2, "second unique victory grants exactly one additional passive point")
