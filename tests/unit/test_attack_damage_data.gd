...
func run() -> Array[String]:
	...
	var rows: Array[Dictionary] = [
		...
		{"path":"res://data/attacks/mage_burst.tres", "id":&"mage_burst", "kind":AttackDefinition.Kind.AREA_PROJECTILE, "type":&"fire", "amount":24.0, "cooldown":1.5, "range":12.0, "speed":11.0, "area":2.5, "tags":[&"area", &"caster", &"fire", &"projectile"], "crit":true},
		{"path":"res://data/attacks/cleric_bolt.tres", "id":&"cleric_bolt", "kind":AttackDefinition.Kind.PROJECTILE, "type":&"lightning", "amount":8.0, "cooldown":1.0, "range":10.0, "speed":13.0, "area":0.0, "tags":[&"caster", &"lightning", &"projectile"], "crit":true},
		...
		{"path":"res://data/attacks/rogue_flurry.tres", "id":&"rogue_flurry", "kind":AttackDefinition.Kind.MELEE_CLEAVE, "type":&"physical", "amount":8.0, "cooldown":0.32, "range":2.0, "speed":0.0, "area":0.9, "tags":[&"area", &"melee", &"physical", &"skirmisher"], "crit":true},
