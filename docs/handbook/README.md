...
> **Leader loadout continuity:** Chapter 12 through `3c753f41c24df7c7a3093e253f775109e21afb75`<br>
> **Godot version:** `4.7.1`
...
3. Chapters 9–12 become operational references for debugging, Git safety, architecture, item/storage ownership, leader equipment, and extraction continuity.
...
12. [Equipment, Stash, and Extraction Continuity](12-equipment-stash-and-extraction.md)
...
- Use [Equipment, Stash, and Extraction Continuity](12-equipment-stash-and-extraction.md) to inspect or author leader loadouts, shared Armoury/Warehouse storage, City extraction unlocks, compatibility warnings, and per-profile setup boundaries.
